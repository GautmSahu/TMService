"""
Django settings for TMService project.
...
WSGI_APPLICATION = 'TMService.wsgi.application'
...
SIMPLE_JWT = {
    ...
    'BLACKLIST_AFTER_ROTATION': False,  # If refresh tokens should be blacklisted after rotation
}
